                ...
                <aside class="md:w-1/3 bg-gradient-to-b from-blue-600 to-indigo-700 text-white p-6 rounded-lg shadow-lg">
                    <div class="sticky top-8">
                        <div class="text-center mb-8">
                            ...
                            <h2 class="mt-4 text-3xl font-bold">{{ $client->name }}</h2>
                            <p class="text-white">Client at Fit Fusion</p>
                        </div>
                        <nav class="mt-8 space-y-4">
                            ...
                            <a href="#physical" class="block py-2 px-4 rounded-lg hover:bg-white hover:bg-opacity-20 transition duration-200 ease-in-out">Physical Information</a>
                            <a href="#fitness" class="block py-2 px-4 rounded-lg hover:bg-white hover:bg-opacity-20 transition duration-200 ease-in-out">Fitness Information</a>
